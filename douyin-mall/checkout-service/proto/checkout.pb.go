...
type CheckoutReq struct {
	...
	CreditCard    *api.CreditCardInfo    `protobuf:"bytes,6,opt,name=credit_card,json=creditCard,proto3" json:"credit_card,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CheckoutReq) GetCreditCard() *api.CreditCardInfo {
	if x != nil {
		return x.CreditCard
	}
	return nil
...
var file_checkout_proto_rawDesc = string([]byte{
	...
	0x16, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_checkout_proto_goTypes = []any{
	...
	(*api.CreditCardInfo)(nil), // 3: payment.CreditCardInfo
}
