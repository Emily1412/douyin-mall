...
type ProductCatalogServiceClient interface {
	...
	CreateProducts(ctx context.Context, in *Product, opts ...grpc.CallOption) (*emptypb.Empty, error)
	DeleteProducts(ctx context.Context, in *DeleteProductsInfo, opts ...grpc.CallOption) (*emptypb.Empty, error)
	UpdateProducts(ctx context.Context, in *Product, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *productCatalogServiceClient) CreateProducts(ctx context.Context, in *Product, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *productCatalogServiceClient) DeleteProducts(ctx context.Context, in *DeleteProductsInfo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (c *productCatalogServiceClient) UpdateProducts(ctx context.Context, in *Product, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type ProductCatalogServiceServer interface {
	...
	CreateProducts(context.Context, *Product) (*emptypb.Empty, error)
	DeleteProducts(context.Context, *DeleteProductsInfo) (*emptypb.Empty, error)
	UpdateProducts(context.Context, *Product) (*emptypb.Empty, error)
...
func (UnimplementedProductCatalogServiceServer) CreateProducts(context.Context, *Product) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateProducts not implemented")
}
func (UnimplementedProductCatalogServiceServer) DeleteProducts(context.Context, *DeleteProductsInfo) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteProducts not implemented")
}
func (UnimplementedProductCatalogServiceServer) UpdateProducts(context.Context, *Product) (*emptypb.Empty, error) {
...
func _ProductCatalogService_CreateProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductCatalogServiceServer).CreateProducts(ctx, req.(*Product))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ProductCatalogService_DeleteProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductCatalogServiceServer).DeleteProducts(ctx, req.(*DeleteProductsInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ProductCatalogService_UpdateProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductCatalogServiceServer).UpdateProducts(ctx, req.(*Product))
	}
	return interceptor(ctx, in, info, handler)
}
