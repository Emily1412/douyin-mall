...
func (x *EmptyCartResp) Reset() {
	*x = EmptyCartResp{}
	mi := &file_cart_service_proto_cart_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EmptyCartResp) Descriptor() ([]byte, []int) {
	return file_cart_service_proto_cart_proto_rawDescGZIP(), []int{7}
}
...
var file_cart_service_proto_cart_proto_rawDesc = string([]byte{
	...
	0x61, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x14, 0x5a, 0x12, 0x63, 0x61, 0x72,
...
var file_cart_service_proto_cart_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
